...
function SeeUserData({ userDivData, userDiv, setuserDiv }) {
  return (
    <>
      ...
      <div
        className={`${userDiv} top-0 left-0 h-screen w-full flex items-center justify-center text-zinc-900`}
      >
        <div className="bg-white rounded-lg p-4 w-[80%] md:w-[50%] lg:w-[40%]">
